...
public class MyFriendTrainersListAdapter extends RecyclerView.Adapter<MyFriendTrainersListAdapter.MyTrainersViewHolder> {
    ...
    public MyFriendTrainersListAdapter(Fragment myTrainersFragment) {
        mMyTrainersFragment = myTrainersFragment;

        mTraineeId = mMyTrainersFragment.getArguments().getString("traineeId");

        mDatabaseTraineeTrainersReference = FirebaseDatabase.getInstance().getReference().child("Users/Trainees/" + mTraineeId + "/MyTrainers");
    ...
    public void onBindViewHolder(final MyTrainersViewHolder holder, int position) {
        ...
        holder.trainerCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mMyTrainersFragment.getContext(), MyFriendTrainerActivity.class);
