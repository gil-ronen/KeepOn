...
public class TraineeWeeklyTasksListAdapter extends RecyclerView.Adapter<TraineeWeeklyTasksListAdapter.WeeklyTasksListViewHolder> {
    ...
    public TraineeWeeklyTasksListAdapter() {
    ...
    private void setWeeklyTaskToFirebase(TraineeWeeklyTask traineeWeeklyTask) {
        String key = mDatabaseTraineeWeeklyTasksReference.push().getKey();
        Map<String, Object> traineeWeeklyTaskValues = traineeWeeklyTask.toMap();
        Map<String, Object> childUpdates = new HashMap<>();

        childUpdates.put(key, traineeWeeklyTaskValues);

        mDatabaseTraineeWeeklyTasksReference.updateChildren(childUpdates);
    }
