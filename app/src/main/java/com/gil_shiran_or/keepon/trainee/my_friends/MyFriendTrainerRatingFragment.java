...
public class MyFriendTrainerRatingFragment extends Fragment {

    private DatabaseReference mDatabaseRatingReference;
    private MyFriendTrainerReviewsListAdapter mMyFriendTrainerReviewsListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_my_friend_trainer_rating, container, false);
    }
    ...
    private void buildReviewsRecyclerView() {
        ...
        mMyFriendTrainerReviewsListAdapter = new MyFriendTrainerReviewsListAdapter(mTrainerId);

        reviewsRecyclerView.setLayoutManager(layoutManager);
        reviewsRecyclerView.setAdapter(mMyFriendTrainerReviewsListAdapter);
    }
    ...
    public void onDestroy() {
        ...
        mMyFriendTrainerReviewsListAdapter.cleanUp();
    }
}
