...
public class MyFriendWeeklyTasksListAdapter extends RecyclerView.Adapter<MyFriendWeeklyTasksListAdapter.WeeklyTasksListViewHolder> {
    ...
    public MyFriendWeeklyTasksListAdapter(String traineeId) {
