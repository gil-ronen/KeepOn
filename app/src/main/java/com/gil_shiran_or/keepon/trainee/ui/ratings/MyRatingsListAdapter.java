...
public class MyRatingsListAdapter extends RecyclerView.Adapter<MyRatingsListAdapter.MyRatingsViewHolder> {
    ...
    public MyRatingsListAdapter(List<MyRatingsItem> myRatingsList, Context context) {
