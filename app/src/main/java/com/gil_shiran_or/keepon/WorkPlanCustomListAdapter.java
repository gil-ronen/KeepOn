 ...
 */
public class WorkPlanCustomListAdapter extends BaseAdapter {
    private ArrayList<WorkPlanListItem> listData;
    private LayoutInflater layoutInflater;
    public WorkPlanCustomListAdapter(Context aContext, ArrayList<WorkPlanListItem> listData) {
    ...
    public View getView(int position, View v, ViewGroup vg) {
        ViewHolder holder;
        if (v == null) {
            v = layoutInflater.inflate(R.layout.workplan_list_row, null);
