...
public class MainWeeklySlotsPickerAdapter extends RecyclerView.Adapter<MainWeeklySlotsPickerAdapter.MyViewHolder>{
    ...
    public MainWeeklySlotsPickerAdapter(Activity activity, DatabaseReference ref, String dateForApp, String dateForDB, String traineeId) {
        mActivity = activity;
    ...
    @NonNull
    @Override
    public MainWeeklySlotsPickerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new MainWeeklySlotsPickerAdapter.MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_time_slot,viewGroup, false));
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final MainWeeklySlotsPickerAdapter.MyViewHolder myViewHolder, int i) {
