...
public class PlanWeeklyScheduleFragment extends Fragment {
    ...
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter1;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter2;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter3;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter4;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter5;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter6;
    private TrainerEditTimeSlotsAdapter trainerEditTimeSlotsAdapter7;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_main_weekly_schedule, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {

        mTitlePage = view.findViewById(R.id.main_titlePage);
        mSubtitlePage = view.findViewById(R.id.main_subtitlePage);
        mBtnAddNew = view.findViewById(R.id.main_btnAddNew);
        mEndPage = view.findViewById(R.id.main_endPage);
        ...
        mTimeSlotsRecyclerView1 = view.findViewById(R.id.main_timeSlotsList1);
        ...
        ViewGroup day1SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay1);
        ...
        mTimeSlotsRecyclerView2 = view.findViewById(R.id.main_timeSlotsList2);
        ...
        ViewGroup day2SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay2);
        ...
        mTimeSlotsRecyclerView3 = view.findViewById(R.id.main_timeSlotsList3);
        ...
        ViewGroup day3SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay3);
        ...
        mTimeSlotsRecyclerView4 = view.findViewById(R.id.main_timeSlotsList4);
        ...
        ViewGroup day4SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay4);
        ...
        mTimeSlotsRecyclerView5 = view.findViewById(R.id.main_timeSlotsList5);
        ...
        ViewGroup day5SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay5);
        ...
        mTimeSlotsRecyclerView6 = view.findViewById(R.id.main_timeSlotsList6);
        ...
        ViewGroup day6SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay6);
        ...
        mTimeSlotsRecyclerView7 = view.findViewById(R.id.main_timeSlotsList7);
        ...
        ViewGroup day7SlotsExpanderViewGroup = view.findViewById(R.id.main_expandableDay7);
        ...
        mBtnAddNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), AddNewSlotActivity.class);
    ...
    public void onStart() {
        ...
        trainerEditTimeSlotsAdapter1 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB1), dateForApp1, dateForDB1);
        mTimeSlotsRecyclerView1.setAdapter(trainerEditTimeSlotsAdapter1);

        trainerEditTimeSlotsAdapter2 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB2), dateForApp2, dateForDB2);
        mTimeSlotsRecyclerView2.setAdapter(trainerEditTimeSlotsAdapter2);

        trainerEditTimeSlotsAdapter3 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB3), dateForApp3, dateForDB3);
        mTimeSlotsRecyclerView3.setAdapter(trainerEditTimeSlotsAdapter3);

        trainerEditTimeSlotsAdapter4 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB4), dateForApp4, dateForDB4);
        mTimeSlotsRecyclerView4.setAdapter(trainerEditTimeSlotsAdapter4);

        trainerEditTimeSlotsAdapter5 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB5), dateForApp5, dateForDB5);
        mTimeSlotsRecyclerView5.setAdapter(trainerEditTimeSlotsAdapter5);

        trainerEditTimeSlotsAdapter6 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB6), dateForApp6 ,dateForDB6);
        mTimeSlotsRecyclerView6.setAdapter(trainerEditTimeSlotsAdapter6);

        trainerEditTimeSlotsAdapter7 = new TrainerEditTimeSlotsAdapter(this, databaseReference.child(dateForDB7), dateForApp7, dateForDB7);
        mTimeSlotsRecyclerView7.setAdapter(trainerEditTimeSlotsAdapter7);
    ...
    public void onStop() {
        ...
        trainerEditTimeSlotsAdapter1.clenup();
        trainerEditTimeSlotsAdapter2.clenup();
        trainerEditTimeSlotsAdapter3.clenup();
        trainerEditTimeSlotsAdapter4.clenup();
        trainerEditTimeSlotsAdapter5.clenup();
        trainerEditTimeSlotsAdapter6.clenup();
        trainerEditTimeSlotsAdapter7.clenup();
